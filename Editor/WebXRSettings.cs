...
namespace PureMilk.WebXR.Editor
{
    /// <summary>
    /// Holds settings that are used to configure the Unity ARCore Plugin.
    /// </summary>
    [System.Serializable]
    [XRConfigurationData("WebXR", "PureMilk.WebXR.Editor.WebXRSettings")]
    public class WebXRSettings : ScriptableObject
    {
        ...
        /// </remarks>
        public static WebXRSettings GetOrCreateSettings()
        {
            var settings = currentSettings;
            if (settings != null)
                return settings;

            return CreateInstance<WebXRSettings>();
        }
        ...
        /// and modify these settings in the **XR Plug-in Management** section of your **Project Settings** window.
        /// </remarks>
        public static WebXRSettings currentSettings
        {
            get => EditorBuildSettings.TryGetConfigObject(k_SettingsKey, out WebXRSettings settings) ? settings : null;
        ...
        const string k_SettingsKey = "PureMilk.WebXR.Editor.WebXRSettings";
    }
}
